	...
	for i in range(len(scores)):
		if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
			...
			if response == "OK":
				...
				dynamodb = boto3.resource('dynamodb', region_name='ap-southeast1')  # Replace 'your-region' with your AWS region
				table = dynamodb.Table('smarthome')  # Replace 'your-dynamodb-table' with your DynamoDB table name
				...
				image_filename = f"failed_capture_{time.strftime('%Y%m%d%H%M%S')}.jpg"
